...
from generator.core import UserSimulator, BustOutProfile, SleeperProfile, GenerationConfig, UserSequenceResult
...
class DataGenerator:
    ...
    def generate_dataset_with_sequences(self, num_users: int = 100, fraud_rate: float = 0.05) -> UserSequenceResult:
        """Generate a complete dataset with user sequences using core simulator."""
        from generator.core import GenerationConfig
        all_records = []
        all_metadata = []
