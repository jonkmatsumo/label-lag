...
from inference_server.config import InferenceServerConfig, load_config
from inference_server.logging import configure_logging
...
def serve() -> None:
    ...
    logger.info("inference_server listening on %s", listen_addr)
    server.start()
