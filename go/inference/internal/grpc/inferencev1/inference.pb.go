...
type ScoreRequest struct {
	...
	FallbackMode        *string                `protobuf:"bytes,7,opt,name=fallback_mode,json=fallbackMode,proto3,oneof" json:"fallback_mode,omitempty"`
...
func (x *ScoreRequest) GetFallbackMode() string {
...
func (x *ScoreResponse) GetFallbackUsed() bool {
	if x != nil {
...
const file_inference_v1_inference_proto_rawDesc = "" +
	"\n" +
	"\x1cinference/v1/inference.proto\x12\finference.v1\x1a\x1cgoogle/protobuf/struct.proto\"\x9d\x02\n" +
	...
	"\rfallback_mode\x18\a \x01(\tH\x00R\ffallbackMode\x88\x01\x01B\x10\n" +
	"\x0e_fallback_mode\"\xfa\x01\n" +
	...
	"\rfeatures_used\x18\x05 \x01(\v2\x17.google.protobuf.StructR\ffeaturesUsed\x12#\n" +
	...
	"\x05Score\x12\x1a.inference.v1.ScoreRequest\x1a\x1b.inference.v1.ScoreResponseBUZSgithub.com/jonkmatsumo/label-lag/go/inference/internal/grpc/inferencev1;inferencev1b\x06proto3"
...
func file_inference_v1_inference_proto_init() {
	...
	file_inference_v1_inference_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
