...
func (x *SignalRequest) Reset() {
	*x = SignalRequest{}
	mi := &file_inference_v1_signal_proto_msgTypes[0]
...
func (*SignalRequest) Descriptor() ([]byte, []int) {
	return file_inference_v1_signal_proto_rawDescGZIP(), []int{0}
}
...
func (x *RiskComponent) Reset() {
	*x = RiskComponent{}
	mi := &file_inference_v1_signal_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RiskComponent) Descriptor() ([]byte, []int) {
	return file_inference_v1_signal_proto_rawDescGZIP(), []int{1}
}
...
func (x *MatchedRule) Reset() {
	*x = MatchedRule{}
	mi := &file_inference_v1_signal_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MatchedRule) Descriptor() ([]byte, []int) {
	return file_inference_v1_signal_proto_rawDescGZIP(), []int{2}
}
...
func (x *SignalResponse) Reset() {
	*x = SignalResponse{}
	mi := &file_inference_v1_signal_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SignalResponse) Descriptor() ([]byte, []int) {
	return file_inference_v1_signal_proto_rawDescGZIP(), []int{3}
}
...
var File_inference_v1_signal_proto protoreflect.FileDescriptor

const file_inference_v1_signal_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"debug_info\x18\v \x01(\v2\x17.google.protobuf.StructR\tdebugInfoBQZOgithub.com/jonkmatsumo/label-lag/go/inference/internal/http/gatewayv1;gatewayv1b\x06proto3"

var (
	file_inference_v1_signal_proto_rawDescOnce sync.Once
	file_inference_v1_signal_proto_rawDescData []byte
)

func file_inference_v1_signal_proto_rawDescGZIP() []byte {
	file_inference_v1_signal_proto_rawDescOnce.Do(func() {
		file_inference_v1_signal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_inference_v1_signal_proto_rawDesc), len(file_inference_v1_signal_proto_rawDesc)))
	})
	return file_inference_v1_signal_proto_rawDescData
}

var file_inference_v1_signal_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_inference_v1_signal_proto_goTypes = []any{
...
var file_inference_v1_signal_proto_depIdxs = []int32{
...
func init() { file_inference_v1_signal_proto_init() }
func file_inference_v1_signal_proto_init() {
	if File_inference_v1_signal_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_inference_v1_signal_proto_rawDesc), len(file_inference_v1_signal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_inference_v1_signal_proto_goTypes,
		DependencyIndexes: file_inference_v1_signal_proto_depIdxs,
		MessageInfos:      file_inference_v1_signal_proto_msgTypes,
	}.Build()
	File_inference_v1_signal_proto = out.File
	file_inference_v1_signal_proto_goTypes = nil
	file_inference_v1_signal_proto_depIdxs = nil
}
